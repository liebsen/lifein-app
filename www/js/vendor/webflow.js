...
(function () {
  ...
  Webflow.define('links', module.exports = function($, _) {
    ...
    function select(link) {
      ...
      var segment = '/' + slug.split('/')[1]
      var match = (tempLink.href === location.href) || (href === slug) || (href === segment) || (indexPage.test(href) && dirList.test(slug));
  ...
  Webflow.define('slider', module.exports = function($, _) {
    ...
    function maskChanged(data) {
      if(!data||!data.mask) return false
